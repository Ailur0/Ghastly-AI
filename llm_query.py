"""
llm_query.py — Groq cloud client with streaming responses

Sends transcribed question + context to Groq's OpenAI-compatible
/chat/completions endpoint and streams the response back token-by-token for
minimum latency. Screen captures go to the same endpoint with an image_url
